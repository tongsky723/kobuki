...
void EventManager::update(const CoreSensors::Data &new_state, const std::vector<uint16_t> &cliff_data) {
  ...
  if (last_state.bumper != new_state.bumper)
  {
    ...
    // if ((new_state.bumper ^ last_state.bumper) == CoreSensors::Flags::CenterCBumper) {
    // // else if ((new_state.bumper ^ last_state.bumper) == CoreSensors::Flags::CenterCBumper) {
    // // if (new_state.bumper == CoreSensors::Flags::CenterCBumper) {
    //   event.bumper = BumperEvent::CenterC;
    //   if (new_state.bumper & CoreSensors::Flags::CenterCBumper) {
    //     event.state = BumperEvent::Pressed;
    //   } else {
    //     event.state = BumperEvent::Released;
...
if ((new_state.bumper ^ last_state.bumper) & CoreSensors::Flags::CenterBumper) {
    // else if ((new_state.bumper ^ last_state.bumper) == CoreSensors::Flags::CenterBumper) {
...
if ((new_state.bumper ^ last_state.bumper) & CoreSensors::Flags::RightBumper) {
    // else if ((new_state.bumper ^ last_state.bumper) == CoreSensors::Flags::RightBumper) {
...
// if ((new_state.bumper ^ last_state.bumper) == CoreSensors::Flags::CenterRBumper) {
//     // else if ((new_state.bumper ^ last_state.bumper) & CoreSensors::Flags::CenterRBumper) {
//     // if (new_state.bumper == CoreSensors::Flags::CenterRBumper) {
//       event.bumper = BumperEvent::CenterR;
//       if (new_state.bumper & CoreSensors::Flags::CenterRBumper) {
//         event.state = BumperEvent::Pressed;
//       } else {
//         event.state = BumperEvent::Released;
